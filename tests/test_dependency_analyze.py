...
program_compiled_QR = compiler.lpcompile(QR)(Vs, Ts, Rs, Ss, 4, 0)
...
print("parents qr", compiler.find_parents(program_compiled_QR[1], program_compiled_QR, i=0, j=0, level=0))
end = timer()
print(end - start)
